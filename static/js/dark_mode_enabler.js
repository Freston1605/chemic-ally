 ...
 * Toggles Bootstrap 5.3 data-bs-theme attribute on <html>.
 *
 * Expected markup:
 *   <button id="bd-theme" type="button" aria-label="Toggle theme">
 *     <span class="theme-icon-active"></span>
 *   </button>
 *   <span class="theme-text" aria-hidden="true"></span>
 */
(function () {
  'use strict';
  ...
  function setTheme(theme) {
    ...
    if (activeIcon) activeIcon.innerHTML = ICONS[theme];
  }
  ...
  document.addEventListener('DOMContentLoaded', function () {
    var btn = document.getElementById('bd-theme');
    if (!btn) return;
